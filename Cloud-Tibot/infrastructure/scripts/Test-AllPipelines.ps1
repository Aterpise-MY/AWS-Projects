...
function Test-Prerequisites {
    ...
    $testFiles = @(
        "..\..\tests\fixtures\test-payloads\test-amplify-failure.json",
        "..\..\tests\fixtures\test-payloads\test-github-pr.json",
        "..\..\tests\fixtures\test-payloads\test-github-push.json",
        "..\..\tests\fixtures\test-payloads\test-github-workflow-failure.json",
        "..\..\tests\fixtures\test-payloads\test-finops-cost-alert.json",
        "..\..\tests\fixtures\test-payloads\test-finops-terraform-failure.json"
    )
...
function Test-Module1-AutoRemediator {
    ...
    $results += Test-LambdaFunction `
        ...
        -PayloadFile "..\..\tests\fixtures\test-payloads\test-amplify-failure.json" `
...
function Test-Module2-GitRadar {
    ...
    $results += Test-LambdaFunction `
        -FunctionName $functionName `
        -PayloadFile "..\..\tests\fixtures\test-payloads\test-github-push.json" `
        -TestDescription "GitHub Push Event Handling"
    
    # Test 2: Pull Request Event (via Lambda)
    $results += Test-LambdaFunction `
        -FunctionName $functionName `
        -PayloadFile "..\..\tests\fixtures\test-payloads\test-github-pr.json" `
        -TestDescription "Pull Request Analysis"
    
    # Test 3: Workflow Failure Event (via Lambda)
    $results += Test-LambdaFunction `
        -FunctionName $functionName `
        -PayloadFile "..\..\tests\fixtures\test-payloads\test-github-workflow-failure.json" `
...
function Test-Module3-FinOpsSentinel {
    ...
    $results += Test-LambdaFunction `
        -FunctionName $functionName `
        -PayloadFile "..\..\tests\fixtures\test-payloads\test-finops-cost-alert.json" `
        -TestDescription "Cost Anomaly Detection and Optimization"
    
    # Test 2: Terraform Failure Alert
    $results += Test-LambdaFunction `
        -FunctionName $functionName `
        -PayloadFile "..\..\tests\fixtures\test-payloads\test-finops-terraform-failure.json" `
