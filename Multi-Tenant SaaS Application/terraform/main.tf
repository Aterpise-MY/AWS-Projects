...
resource "aws_lambda_function" "users" {
  ...
  filename         = "${path.module}/../lambda/users_handler.zip"
  source_code_hash = filebase64sha256("${path.module}/../lambda/users_handler.zip")
  memory_size      = 256
  timeout          = 30
...
resource "aws_lambda_function" "orders" {
  ...
  runtime          = "python3.12"
  handler          = "handler.lambda_handler"
  filename         = "${path.module}/../lambda/orders_handler.zip"
  source_code_hash = filebase64sha256("${path.module}/../lambda/orders_handler.zip")
  memory_size      = 256
  timeout          = 30
...
resource "aws_lambda_function" "auth" {
  ...
  source_code_hash = filebase64sha256("${path.module}/../lambda/auth_handler.zip")
  memory_size      = 256
  timeout          = 30
